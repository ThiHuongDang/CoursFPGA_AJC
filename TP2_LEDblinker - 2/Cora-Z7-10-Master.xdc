...
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { end_counter }]; #IO_L4P_T0_35 Sch=btn[1]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { restart }]; #IO_L4P_T0_35 Sch=btn[1]
